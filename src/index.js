...
class ServerlessOfflineDynamoDBStreams {
  ...
  getTableName(tableEvent) {
    ...
    throw new Error(
      `TableName not found for event: ${JSON.stringify(tableEvent, null, 2)}.
      See https://github.com/godu/serverless/tree/master/packages/serverless-offline-dynamodb-streams#functions`
    );
  }
